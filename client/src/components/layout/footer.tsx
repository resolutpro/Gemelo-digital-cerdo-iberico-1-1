      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col items-center gap-4">
          <img
            ...
            onLoad={(e) => {
              console.log(
                "[FOOTER] ✅ Imagen cargada correctamente:",
                e.currentTarget.src,
              );
              console.log(
                "[FOOTER] Dimensiones naturales:",
            ...
            onError={(e) => {
              ...
              console.error(
                "[FOOTER] Rutas alternativas a probar:",
                alternatives,
              );
              //e.currentTarget.alt =
              //"Financiado por la Unión Europea - Next Generation EU";
              e.currentTarget.alt = "footer";
            }}
          />
